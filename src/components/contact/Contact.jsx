    ...
    <section className="contact section" id="contact">
      <motion.div onViewportEnter={() => setSelectedPage("contact")}>
        ...
        <div className="contact__container container grid">
          <div className="contact__content">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <a
                  href="mailto:makarabartosz@proton.me"
              ...
              <div className="contact__card">
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=+447587958742&text=Please call me back and let's talk business!"
                  className="contact__button"
                >
                  Text me
                  <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              ...
              <div className="contact__card">
                ...
                <a href="tel:+48724244396" className="contact__button">
                  Call me
                  <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                </a>
              </div>
          ...
          <div className="contact__content">
            <h3 className="contact__title">Drop a message</h3>
